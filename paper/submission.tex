...
calibrated system appears only in transferred form, because its per-language
thresholds are defined on the full label set and no subset-fitted calibrated
variant exists.}
