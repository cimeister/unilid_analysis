...
\begin{tabular}{lrrrr}
\toprule
\textbf{Length (chars)} & \corrrev{\textbf{\# Lines}} & \textbf{Original} & \textbf{Raw rescore} & \textbf{Normalized} \\
\midrule
...
\caption{%
  ...
  implementation. \corrrev{Evaluated on the diagnostic half of the $500{,}000$-line draw ($250{,}000$ lines; \cref{app:protocol}).} Full normalization lowers overall accuracy from $0.960$ to \corrrev{$0.837$}, with the
