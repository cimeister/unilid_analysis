#!/bin/bash
#SBATCH --job-name=unilid-extflores-corr
...
#SBATCH --output=/capstor/scratch/cscs/cmeister747/unilid_analysis/logs/extflores_corrected_%j.out
#SBATCH --error=/capstor/scratch/cscs/cmeister747/unilid_analysis/logs/extflores_corrected_%j.err
set -euo pipefail
#
...
echo "=== corrected flores scoring at $(date) on $(hostname) ==="
echo "commit: $(git rev-parse HEAD)"
${PYTHON} -u -m analysis.external_bench_eval --stage score --bench flores \
